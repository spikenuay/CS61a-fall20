...
def count_coins(total):
    ...
    """def count_coins_helper(total, smallest_coin):
        if total == 0:
            ...
            return 0
        elif smallest_coin == 0:
            return 0
        else:
            next_coin = next_largest_coin(smallest_coin)
            with_smallest_coin = count_coins_helper(total - smallest_coin, smallest_coin)
            without_smallest_coin = count_coins_helper(total, next_coin)
